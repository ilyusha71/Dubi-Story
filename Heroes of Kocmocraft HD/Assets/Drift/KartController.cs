...
public class KartController : MonoBehaviour
{
    ...
    public void Boost()
    {
        ...
        if (driftMode > 0)
        {
            ...
            DOVirtual.Float(0, 1, .5f, ChromaticAmount).OnComplete(() => DOVirtual.Float(1, 0, 3.5f, ChromaticAmount));
    ...
    {
        rotate = (steering * direction) * amount*0.5f;
    }
    ...
    {
        ((ChromaticAberration)(postProfile.components[3])).intensity.value = x;
    }
...
//     {
//         // VolumeComponent QQQ;
//         // QQQ = postProfile.components[3];
// var aaa = postProfile.components[3];

//         Debug.Log(postProfile.components[3].name);
//         // QQQ.Override(QQQ,1);
//         postProfile.components[3].Override(postProfile.components[3], 1);
//         postVolume.profile = postProfile;
//         // .GetSetting<ChromaticAberration>().intensity.value = x;
//     }
